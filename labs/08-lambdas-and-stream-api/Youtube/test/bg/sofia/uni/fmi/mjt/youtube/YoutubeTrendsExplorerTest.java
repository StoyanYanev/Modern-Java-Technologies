...
public class YoutubeTrendsExplorerTest {
    ...
    @Test
    public void testFindIdOfLeastLikedVideoWithEmptyDataShouldReturnNull() {
        assertNull(emptyExplorer.findIdOfLeastLikedVideo());
    }
    ...
    @Test
    public void testFindIdOfMostLikedLeastDislikedVideoWithEmptyDataShouldReturnNull() {
        assertNull(emptyExplorer.findIdOfMostLikedLeastDislikedVideo());
    }
    ...
    @Test
    public void testFindIdOfMostTaggedVideoWithEmptyDataShouldReturnNull() {
        assertNull(emptyExplorer.findIdOfMostTaggedVideo());
    }
    ...
    @Test
    public void testFindTitleOfFirstVideoTrendingBefore100KViewsWithEmptyDataShouldReturnNull() {
        assertNull(emptyExplorer.findTitleOfFirstVideoTrendingBefore100KViews());
    }
    ...
    @Test
    public void testFindIdOfMostTrendingVideoWithEmptyDataShouldReturnNull() {
        assertNull(emptyExplorer.findIdOfMostTrendingVideo());
    }
}